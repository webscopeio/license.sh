...
from license_sh.runners.yarn import parse_yarn_lock, get_name, get_flat_tree, get_dependency_tree
...
'''
  ...
  def test_nested_children_flat_tree(self):
    ...
    tree = get_flat_tree(tree_data, package_map)
    elem = tree.get("@babel/helper-create-class-features-plugin@^7.5.5").get('dependencies').get('@babel/plugin-syntax-object-rest-spread@^7.2.0')
  ...
  def test_children_with_nested_child_flat_tree(self):
    ...
    elem2 = tree.get("class-features-plugin@^7.5.5").get('dependencies').get('utils@^7.0.0')
  ...
  def test_simple_dep_tree(self):
    ...
    self.assertEqual(tree.children[0].name, '@babel/helper-create-class-features-plugin')
    self.assertEqual(tree.children[0].version, '7.5.5')
    self.assertEqual(tree.children[0].children[0].name, '@babel/helper-plugin-utils')
  ...
  def test_shared_dep_tree(self):
    ...
    self.assertEqual(tree.children[0].children[0].children[0].children[0].name, 'shared_child')
    self.assertEqual(tree.children[0].children[0].children[0].children[0].version, '0.5.5')
    self.assertEqual(tree.children[1].name, 'plugin')
    self.assertEqual(tree.children[1].version, '1.2.3')
  ...
  def test_circular_dep_tree(self):
    ...
    self.assertEqual(tree.children[0].children[0].children[0].name, '@babel/helper-create-class-features-plugin')
